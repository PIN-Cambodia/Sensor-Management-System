...
class UserTokensController extends VoyagerBaseController
{
...
public function generateToken($username,$password)
    ...
    /*
    We use Optimus\ApiConsumer to make an "internal" API request.   More on this below.
    */    
    ...
    public function show(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','token'));
    }
    ...
    public function store(Request $request)
    {
      ...
      //  dd($user);
       ...
       // dd($email . ',' . $password);
        ...
        $request->merge(['api_token' =>$token=$this->generateToken($email, $password),]); 

        //dd(json_decode($data));  

        /* end for generating token */   
